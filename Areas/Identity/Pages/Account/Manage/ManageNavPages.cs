...
namespace  EmploymentServiceWebApp.Areas.Identity.Pages.Account.Manage
{
    ...
    public static class ManageNavPages
    {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public static string VacanciesNavClass(ViewContext viewContext) => PageNavClass(viewContext, Vacancies);
		...
		///     directly from your code. This API may change or be removed in future releases.
		/// </summary>
		public static string EmployersNavClass(ViewContext viewContext) => PageNavClass(viewContext, Employers);
